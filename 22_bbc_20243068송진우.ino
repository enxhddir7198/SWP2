...
#define _INTERVAL_DIST    40 // distance sensor interval (unit: ms)
#define _INTERVAL_SERVO   50 // servo interval (unit: ms)
#define _INTERVAL_SERIAL  40 // serial interval (unit: ms)
...
#define _DUTY_MAX 2600 // 2000
#define _DUTY_NEU 1500 // 1500
#define _DUTY_MIN 400 // 1000
...
// Target Distance
#define _DIST_TARGET    135 // Center of the rail (unit:mm)
...
float volt_to_distance(int a_value)
{
  ...
  return 480 + (-1.74*a_value) + 1.63E-03*a_value*a_value;
}
